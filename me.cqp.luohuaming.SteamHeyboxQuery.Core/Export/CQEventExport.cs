...
using me.cqp.luohuaming.SteamHeyboxQuery.Core;
using me.cqp.luohuaming.SteamHeyboxQuery.Core.Domain;
using me.cqp.luohuaming.SteamHeyboxQuery.Sdk.Cqp;
using me.cqp.luohuaming.SteamHeyboxQuery.Sdk.Cqp.Enum;
using me.cqp.luohuaming.SteamHeyboxQuery.Sdk.Cqp.EventArgs;
using me.cqp.luohuaming.SteamHeyboxQuery.Sdk.Cqp.Interface;
using me.cqp.luohuaming.SteamHeyboxQuery.Sdk.Cqp.Expand;
using me.cqp.luohuaming.SteamHeyboxQuery.Sdk.Cqp.Model;
using Unity;
using Unity.Injection;

namespace me.cqp.luohuaming.SteamHeyboxQuery.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.SteamHeyboxQuery", 1, 9, "Steam价格查询", "1.0.2", 1, "落花茗", "使用小黑盒公开API查询游戏价格", authCode);	
